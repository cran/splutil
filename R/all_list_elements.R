...
#' @return Boolean. TRUE if `x` is a list with each element named. FALSE otherwise.
#' @export
...
#' @return Boolean. TRUE if A) `x` is a list, B) All elements in `x` are either null or data.frame. FALSE otherwise.
#' @export
...
#' @return Boolean. TRUE if A) `x` is a list, B) All elements in `x` are either null or list. FALSE otherwise.
#' @export
...
#' @return Boolean. TRUE if A) `x` is a list, B) All elements in `x` are either null or fully named lists. FALSE otherwise.
#' @export
